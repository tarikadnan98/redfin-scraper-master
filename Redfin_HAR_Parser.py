...
with open(file_path_csv, 'w', newline='') as csvfile:
    ...
    for obj in data:
        ...
        for home in homes:
            ...
            writer.writerow([price, zip_code, dataSource_Id, property_id, "https://www.redfin.com"+url, listingRemarks, lot_size_acres, lastSaleDate, latitude, longitude])
...
# drop rows where the 'column_name' value is equal to 'some_value'
